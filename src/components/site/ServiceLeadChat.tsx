  ...
  const submitLead = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, 'contact_requests'), {
        ...
        phone: normalizedLead.phone || normalizedLead.contact,
        email: normalizedLead.email,
        technicalRequest: `[${normalizedLead.service}] ${normalizedLead.technicalRequest}`,
        serviceOrigin: normalizedLead.service,
