...
import { LayoutDashboard, Menu, UserCircle, Wrench, Home, Sparkles, Fingerprint } from 'lucide-react';
              ...
              <DropdownMenuContent align="end" className="w-64 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border border-white/40 dark:border-white/10 shadow-2xl rounded-2xl p-2 mt-2">
                ...
                <DropdownMenuItem asChild className="focus:bg-primary/10 rounded-xl cursor-pointer p-0 group">
                  <Link href="/bienestar" className="flex items-center w-full px-4 py-3">
                    ...
                    <span className="block font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wider">Centro Wellness</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="focus:bg-primary/10 rounded-xl cursor-pointer p-0 group">
                  <Link href="/biometrico" className="flex items-center w-full px-4 py-3">
                    ...
                    <span className="block font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wider">Acceso Biométrico</span>
                  </Link>
                </DropdownMenuItem>
                    ...
                    <SheetClose asChild>
                      <Button asChild className="w-full h-11 bg-fuchsia-500/10 text-fuchsia-500 hover:bg-fuchsia-500/20 rounded-xl border border-fuchsia-500/20">
                        <Link href="/bienestar" className="flex items-center justify-center gap-2">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-widest">Centro Wellness</span>
                        </Link>
                      </Button>
                    </SheetClose>
                    <SheetClose asChild>
                      <Button asChild className="w-full h-11 bg-cyan-500/10 text-cyan-500 hover:bg-cyan-500/20 rounded-xl border border-cyan-500/20">
                        <Link href="/biometrico" className="flex items-center justify-center gap-2">
                          <Fingerprint className="w-4 h-4" />
                          <span className="text-[10px] font-black uppercase tracking-widest">Acceso Biométrico</span>
                        </Link>
                      </Button>
                    </SheetClose>
                    <div className="h-px bg-slate-200 dark:bg-white/10 my-1" />
                    <SheetClose asChild>
                      <Button asChild className="w-full h-11 bg-slate-900 dark:bg-slate-800 text-white rounded-xl border border-cyan-500/30">
